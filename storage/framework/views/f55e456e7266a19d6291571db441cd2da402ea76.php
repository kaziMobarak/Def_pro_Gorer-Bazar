...
<div class=" container my-5">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header"><img src="<?php echo e(asset('user/images/logo.jpg')); ?>" height="200px" width="100%" alt=""></div>

                <div class="card-body">
                    <form action="<?php echo e(url('contact/store')); ?>" method="POST" class="form-group my-5">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kazi ecommerce\ecommerce\resources\views/contact.blade.php ENDPATH**/ ?>