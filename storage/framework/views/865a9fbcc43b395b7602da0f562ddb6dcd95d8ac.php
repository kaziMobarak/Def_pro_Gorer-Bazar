            ...
            <div class="">
                    ...
                    <ul class="ul-wrapper">
                        <li class="li-wrapper">
                            <label class="container">
                                <input class="select_value" id="color" type="checkbox" name="color"  value="<?php echo e($attr->id); ?>">
                                <span style="background-color:<?php echo e($attr->color_id ? $attr->color->color_code : ''); ?>"
                ...
                <div class="attr_section ">
                    ...
                    <ul class="ul-wrapper">
                        <li class="li-wrapper">
                            <label class="container">
                                <input  id="select_value_attr" type="checkbox" name="attr" value="<?php echo e($attr->id); ?>">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kazi ecommerce\ecommerce\resources\views/admin/product/detail.blade.php ENDPATH**/ ?>