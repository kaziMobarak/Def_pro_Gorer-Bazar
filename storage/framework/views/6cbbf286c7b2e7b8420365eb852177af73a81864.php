    ...
    <section class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                <img height="300px" width="100%" src="<?php echo e(asset('user')); ?>/images/logo.jpg" alt="">
            </div>
        </div>
...
<?php echo $__env->make('layouts.user.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kazi ecommerce\ecommerce\resources\views/about.blade.php ENDPATH**/ ?>